"""Evaluate the current routed retriever on held-out queries."""
...
def is_expected_result(result, case) -> bool:
    ...
    """Return whether one result matches acceptable held-out evidence."""
...
def main() -> None:
    ...
    for case in HELDOUT_RETRIEVAL_BENCHMARK:
    ...
    print("Held-Out Routed Retrieval")
